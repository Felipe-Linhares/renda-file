        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-amber-700 to-orange-800 bg-clip-text text-transparent mb-6">
              Catálogo de Produtos - Loja Renda Filé Artesanal
            </h1>
            <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto mb-8 leading-relaxed">
              Descubra nossa coleção completa de peças em renda filé artesanal,
              cada uma criada com técnicas tradicionais e muito carinho. Loja
              especializada em roupas artesanais: vestidos elegantes, saias
              sofisticadas e calças exclusivas. Arte que conta histórias através
              dos fios, unindo tradição e moda contemporânea.
            </p>
            {/* Search Bar */}{" "}
            <div className="max-w-md mx-auto">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Buscar vestidos, saias, calças artesanais..."
                  value={searchQuery}
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-8">
            Renda Filé Artesanal Brasileira
          </h2>
          <div className="prose prose-lg mx-auto text-gray-700 leading-relaxed">
            <p className="mb-6">
              Nossa <strong>loja de renda filé artesanal</strong> oferece uma
              coleção exclusiva de
              <strong> roupas artesanais brasileiras</strong>. Especializamos em{" "}
              <strong>vestidos de renda filé</strong>,
              <strong> saias artesanais</strong> e{" "}
              <strong>calças de renda filé</strong>, todas confeccionadas com
              técnicas tradicionais transmitidas através de gerações.
            </p>
            <p className="mb-6">
              Cada <strong>peça artesanal</strong> é única, feita à mão com{" "}
              <strong>fio de algodão</strong> de alta qualidade. Nossa{" "}
              <strong>moda praia artesanal</strong> combina elegância e
              tradição, perfeita para quem busca{" "}
              <strong>roupas exclusivas</strong> e{" "}
              <strong>peças sob medida</strong>.
            </p>
            <p className="mb-6">
              O <strong>artesanato de renda filé</strong> é uma expressão
              cultural brasileira que preservamos com carinho. Oferecemos{" "}
              <strong>roupas elegantes</strong> para todas as ocasiões:
              <strong> vestidos elegantes</strong> para eventos especiais,{" "}
              <strong>saias elegantes</strong> para o dia a dia e{" "}
              <strong>calças elegantes</strong> para um visual sofisticado.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-12 shadow-xl border border-orange-200">
            <h2 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-orange-600 to-amber-700 bg-clip-text text-transparent mb-6">
              Peças Personalizadas Sob Medida
            </h2>
            <p className="text-lg sm:text-xl text-gray-700 mb-8 sm:mb-10 leading-relaxed">
              Criamos roupas artesanais personalizadas sob medida para você.
              Cada criação é única e feita com todo carinho e dedicação
              artesanal. Vestidos, saias e calças exclusivas em renda filé
              tradicional, seguindo técnicas ancestrais do artesanato
              brasileiro.
            </p>{" "}
            <button
              onClick={() => {
